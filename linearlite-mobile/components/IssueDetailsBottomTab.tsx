...
import { issuesMutations } from '@/schema';

interface IssueDetailsBottomTabProps {
  issueId: string;
}

export default function IssueDetailsBottomTab({
  issueId,
}: IssueDetailsBottomTabProps) {
  ...
  return (
    <>
      ...
      <TextInput
        placeholder="Comment"
        className="bg-zinc-100 dark:bg-zinc-800 mx-4 p-3 rounded-lg mt-4"
      />
